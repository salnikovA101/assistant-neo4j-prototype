...
export function IconGraph() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
      ...
      <path d="M8.7 8.4 16 7.6M8.2 15.4 7.4 9.4M16.2 8.7 16.8 14.2M10.3 17.2 15.7 16.6" />
    </svg>
  );
}
...
export function IconLibrary() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M5 5a2 2 0 0 1 2-2h11v17H7a2 2 0 0 1-2-2V5Z" />
      <path d="M5 18a2 2 0 0 0 2 2h11M9 8h6M9 12h6" />
    </svg>
  );
}
...
export function IconHelp() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9.7 9a2.4 2.4 0 1 1 3.9 1.9c-1 .7-1.6 1.1-1.6 2.4" />
      <path d="M12 17h.01" />
    </svg>
  );
}
...
export function IconCheckpoint() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <circle cx="12" cy="12" r="8" />
      <path d="M12 7v5l3 2M5 5l2.2 2.2" />
    </svg>
  );
}
...
export function IconFork() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M7 7v2c0 3 2 4 5 4s5-1 5-4V7M12 13v4" />
    </svg>
  );
}
